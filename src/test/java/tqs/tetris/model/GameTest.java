...
public class GameTest {
     ...
     * type of test: 
     * caixa blanca --> multiple paths of Game constructors and setters/getters
     * particio equivalent --> default constructor and parameterized constructor
     */
    @Test
     ...
     * type of test:
     * particio equivalent --> each state transitions
     */
    @Test
     ...
     * type of test:
     * particio equivalent --> different piece types and board sizes
     */
    @Test
     ...
     * type of test:
     * caixa blanca --> multiple paths of Game.tick(), Board.collides(), and Board.placeTetromino()
     * particio equivalent --> normal fall, collision at bottom, collision with piece, game over
     * valors limits --> piece at bottom row
     */
    @Test
     ...
     * type of test:
     * caixa blanca --> multiple paths of Game.moveLeft(), Game.moveRight(), and Board.collides()
     * particio equivalent --> move left, move right, collision on left, collision on right
     * valors limits --> piece at leftmost and rightmost columns
     */
    @Test
